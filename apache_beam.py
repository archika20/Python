#using apache beam for connectivity with GCP
#this program will take PROJECT_ID and BUCKET_ID as parameters
#may get error as apache_beam is not completely supported with python3
